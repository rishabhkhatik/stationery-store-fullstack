      ...
      <div style={{
        ...
        <div style={{ padding: '12px', flex: 1, display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <button onClick={handleAddToCart}
            style={{ marginTop: 4, padding: '8px 12px', background: adding ? 'var(--success)' : 'var(--primary)', color: '#fff', borderRadius: 8, fontSize: 13, fontWeight: 500, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'background 0.2s', border: 'none', cursor: 'pointer' }}>
